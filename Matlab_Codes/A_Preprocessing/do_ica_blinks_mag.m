function [ n_comp, comp, components_filename ] = do_ica_blinks_mag(input_filename, data_no_muscle)

%% Load only the MAG channels
cfg         = [];
...
% length(data.time{1})= size(data.trial{1},2)
