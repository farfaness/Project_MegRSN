function [ data_corrected, output_filename ] = reject_all_components_blinks_mag( input_filename, components_filename, components_to_remove )
...
output_filename = [ path '/' name '_ica_eye_corrected' ];
