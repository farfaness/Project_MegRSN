function [components_to_remove, coeff] = find_all_components_cardio_mag(input_filename, data_no_muscle)
...
[path,name,] = fileparts(input_filename) ;
components_to_remove_filename = [ path '/' name '_components_to_remove_cardio.mat' ] ;
