%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% SCRIPT_Batch_BAND_PASS_filtering_continous
%%%
%%% This script filter the data in alpha, beta and theta frequency bands
%%% for the two conditions dataset, on continuous data
%%%
%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%% ALpha Band-pass filtering off the continous data 
 ...
 for i = subjects
   try
 	    ...
 	    datadir =['subjectdata.datadir' int2str(S)]
             ...
             Band_pass_filtering_continuous_data(input_filename, condition, lpfreq, hpfreq, name_band_freq) 
             end
 	    end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
%%%%% Beta Band-pass filtering off the continous data 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%% Theta Band-pass filtering off the continous data 
